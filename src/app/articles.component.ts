...
export class ArticlesComponent
{
  ngOnInit()
  {
    (<any>window).visualize.renderVisualFromConfig('{"type":"donut","dataSet":"ponti","attributes":{"width":260,"height":260,"font_size":"19","color":{"mode":"interpolate","colorspace":"hcl","range":[0,359]},"label_mode":"hover","category_order":"","group_by":"Material of Summit Pavement","title":""}}',
     'visual1');
